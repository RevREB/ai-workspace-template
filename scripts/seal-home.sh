...
# [01] system/bridges.json. Runs from the devbox init_hook — i.e. on entry to
# the box ('devbox shell') and on every 'devbox run'. Never on a bare cd:
# .envrc deliberately does not activate devbox.
#
